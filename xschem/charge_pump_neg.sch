...
N 360 50 390 50 {
lab=stage2}
N 180 140 180 160 {lab=stage1}
N 320 140 320 160 {lab=stage2}
N 460 140 460 160 {lab=VPRGNEG}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 180 190 2 0 {name=C1 model=cap_mim_m3_1 W=25 L=25 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 320 190 2 0 {name=C2 model=cap_mim_m3_1 W=25 L=25 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 460 190 2 0 {name=C3 model=cap_mim_m3_1 W=30 L=25 MF=1 spiceprefix=X}
