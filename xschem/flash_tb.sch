...
C {flash.sym} 100 -210 0 0 {name=x1}
...
C {devices/lab_wire.sym} -50 -160 0 0 {name=p4 sig_type=std_logic lab=erase_en}
C {devices/lab_wire.sym} 250 -260 2 0 {name=p5 sig_type=std_logic lab=ua[0]}
